...
export function RegisterForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  return (
    <Card
      className="-mt-16 md:-mt-32 border-zinc-300 dark:border-zinc-700 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md shadow-2xl dark:shadow-zinc-900/50 transition-all duration-300 max-w-md w-full mx-auto"
      {...props}
    >
      <CardHeader className="space-y-1.5">
        <CardTitle className="text-center text-2xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">
          Create an account
        </CardTitle>
        <CardDescription className="text-center text-zinc-500 dark:text-zinc-400 text-sm">
          Enter your details below to activate your thought space account
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form
      ...
      <CardFooter className="flex flex-col gap-2 pt-2">
        ...
        <div className="relative w-full flex items-center justify-center my-2 text-xs uppercase">
          ...
          <span className="relative bg-white dark:bg-[#121214] px-3 text-zinc-600 dark:text-zinc-400 font-medium">
            Or continue with
          </span>
        </div>
